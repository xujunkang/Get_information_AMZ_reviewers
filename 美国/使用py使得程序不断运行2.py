...
# subprocess.Popen('C:/Users/Administrator/AppData/Local/pyppeteer/pyppeteer/local-chromium/588429/chrome-win32/chrome.exe  --remote-debugging-port=9555 --user-data-dir="E:/pyppeteer/AutomationProfile')
CMD = "C:\\Users\\Administrator\\Desktop\\python项目\\日本爬商品评论\\使用pyppteer来实现异步爬取评论者个人主页信息.py"               #需要执行程序的绝对路径，支持jar 如：D:\\\\calc.exe 或者D:\\\\test.jar
    ...
    def __init__(self,sleep_time,cmd):
        ...
        try:
            ...
            while 1:
                ...
                time.sleep(sleep_time * 60)  #休息sleep_time分钟，判断程序状态
